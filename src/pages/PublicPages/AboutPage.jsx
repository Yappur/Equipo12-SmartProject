      ...
      <section className="bg-white flex flex-col md:flex-row items-center gap-12 px-8 md:px-20 py-16">
        ...
        <div className="w-full md:w-1/2 space-y-6 flex flex-col justify-between">
          ...
          <p className="text-gray-600 text-lg">
            Creemos que encontrar trabajo —o al candidato ideal— no debería ser
            complicado. Por eso creamos esta plataforma: para hacer que el
            proceso sea claro, ágil y humano, tanto para quienes buscan como
            para quienes contratan.
          </p>
          <p className="text-gray-600 text-lg">
            Si buscas trabajo, acá vas a encontrar vacantes reales, con procesos
            organizados y seguimiento claro.
          </p>
          <p className="text-gray-600 text-lg">
            Si eres parte de un equipo de RRHH, te damos una herramienta fácil
            de usar para publicar vacantes, gestionar postulaciones y seguir el
            avance de cada proceso en un solo lugar.
          </p>
          <p className="text-gray-600 text-lg">
            Estamos para hacerte la vida más fácil. Ya sea que estés buscando tu
            próxima oportunidad o buscando al próximo talento para tu equipo.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white  flex flex-col lg:flex-row gap-8 px-6 md:px-16 py-10">
        <div className="bg-[#D8E9FF] rounded-xl shadow-md p-6 w-full lg:w-1/2 h-auto">
          ...
          <ul className="list-disc list-inside space-y-2 mb-4">
            <li>Que los candidatos puedan postularse con confianza...</li>
            <li>Los equipos de RRHH tengan una herramienta simple...</li>
          </ul>
          <p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div>
            <p className="text-gray-700">
              ...
              pensada para facilitarle la vida a todos los que participan en un
          ...
          <div>
            <ul className="list-disc list-inside text-gray-700 space-y-1">
              <li>
                <span className="font-medium">Tecnología simple</span>, no
                abrumadora
              </li>
              <li>
                <span className="font-medium">Vacantes reales</span> y activas
              </li>
              <li>
                <span className="font-medium">Seguimiento transparente</span> de
                postulaciones
              </li>
              <li>
                Un <span className="font-medium">equipo humano</span> detrás,
                siempre disponible
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-16">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-[#D8E9FF] rounded-xl shadow-md p-6 w-full min-h-[200px] md:min-h-[250px]">
              ...
              <p className="text-gray-700">
                Sofía diseña soluciones centradas en el usuario que simplifican
                los procesos de selección. Especialista en UX y desarrollo de
                productos SaaS, se asegura de que nuestra plataforma evolucione
